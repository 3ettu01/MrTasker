    ...
    <div class="row container-fluid d-flex align-items-center" style="min-height: 100vh;">
        ...
        <div class="col d-flex flex-column align-items-center">
            ...
            <div class="w-100 mb-2 ms-5 d-flex justify-content-between">
                <a href="<?= base_url('/Colaboraciones/'.$tarea['estado']) ?>" class="btn-simple fs-4 ms-1"> <i class="bi bi-arrow-left-circle"></i> </a>
            ...
            <div class="card-design p-3" style="background-color: <?= $tarea['colorcod'] ?>;"> 
                ...
                <!-- view cargar tarea -->
                <?= view('Pagina_Principal/Colaboraciones/ver_cargar_tarea.php') ?>
                ...
                <div class="ms-3">
                    ...
                    <?= view('Pagina_Principal/Colaboraciones/ver_cargar_subts.php') ?>
                </div>
                
                <div class="text-center"> 
                    <?php if ($tipocolaboracion == 'e'): ?>
